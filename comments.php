            ...
            <div class="comment-box submit-form" id="comment_box">
                ...
                <div class="comment-form">
                    ...
                    <?php if (get_option('comment_registration') && !is_user_logged_in()): ?>
                        <div class="alert alert-warning">کاربر گرامی: برای ارسال دیدگاه ابتدا وارد سایت شوید.</div>
                    <?php else: ?>
                        <?php $user = get_userdata(get_current_user_id());?>

                    <p><?php echo $user->display_name?> عزیز شما مجاز به ارسال دیدگاه هستید</p>
                        <form action="<?php echo site_url() . '/wp-comments-post.php' ?>" method="post">
                            <div class="row">
                                <?php if (!is_user_logged_in()): ?>
                                    ...
                                    <div class="comment-form-cookies-consent global-rtl col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <label for="wp-comment-cookies-consent">ذخیره نام و ایمیل من در مرورگر برای
                                            زمانی که
