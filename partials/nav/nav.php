        ...
        <nav id="navigation" class="navigation navigation-landscape">
            <div class="nav-header">
                <a class="nav-brand" href="<?php echo site_url();?>">
                    <img loading="lazy" src="<?php echo get_template_directory_uri() . '/assets/img/webp/'.(is_front_page()?'logo-light.webp':'logo-dark.webp' )?>" class="logo" alt="logo"/>
                </a>
...
<!--                        <li id="profileName"><a href="#" class="profile-link"><span class="profile-name">صادق یعقوبی</span><img loading="lazy" src="--><?php //echo get_template_directory_uri() . '/assets/img/webp/user-1.webp' ?><!--"  class="circle " width="30" alt=""><span class="submenu-indicator"></span></a>-->
