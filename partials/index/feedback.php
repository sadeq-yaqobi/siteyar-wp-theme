                    ...
                    <div class="arrow_slide three_slide-dots arrow_middle" dir="rtl">
                            ...
                            <div class="bg-light rounded box-shadow">
                                <div class="client-detail-box">
                                    <div class="pic pt-4 d-flex justify-content-around align-items-center">
                                        <img loading="lazy" src="<?php echo get_template_directory_uri().'/assets/img/webp/user-1.webp'?>" alt="">
                        ...
                        <div class="singles_items mb-4">
                            <div class="bg-light rounded box-shadow">
                                <div class="client-detail-box">
                                    <div class="pic pt-4 d-flex justify-content-around align-items-center">
                                        <img loading="lazy" src="<?php echo get_template_directory_uri().'/assets/img/webp/user-2.webp'?>" alt="">
                                        <div class="reviews-comments-item-text reviews-comments-item-text-custom">
                                            <h4>الهام پاکزاد</h4>
                        ...
                        <div class="singles_items mb-4">
                            <div class="bg-light rounded box-shadow">
                                <div class="client-detail-box">
                                    <div class="pic pt-4 d-flex justify-content-around align-items-center">
                                        <img loading="lazy" src="<?php echo get_template_directory_uri().'/assets/img/webp/user-4.webp'?>" alt="">
                                        <div class="reviews-comments-item-text reviews-comments-item-text-custom">
                                            <h4>الهام پاکزاد</h4>
                        ...
                        <div class="singles_items mb-4">
                            <div class="bg-light rounded box-shadow">
                                <div class="client-detail-box">
                                    <div class="pic pt-4 d-flex justify-content-around align-items-center">
                                        <img loading="lazy" src="<?php echo get_template_directory_uri().'/assets/img/webp/user-5.webp'?>" alt="">
                                        <div class="reviews-comments-item-text reviews-comments-item-text-custom">
                                            <h4>الهام پاکزاد</h4>
