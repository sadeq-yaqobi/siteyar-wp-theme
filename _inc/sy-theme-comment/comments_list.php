<?php
function sy_theme_comment($comment, $args) { $comment = $GLOBALS['comment']; ?>
...
<!--                --><?php ?>
 ...
 $user_data = get_userdata($comment->user_id); if ($user_data and $user_data->roles[0] == 'administrator'):?>
                    ...
                    <div class="comment-reply">
                        ...
                        <?php  ?><!--" data-comment-author="--><?php  ?><!--" data-comment-content="--><?php  ?><!--"><span class="icona"><i class="ti-back-right"></i></span>پاسخ</a>-->
                        ...
                        <?php if (current_user_can('manage_options')) { edit_comment_link('<span title="ویرایش"  class="icona comment-edit pl-2"><i class="ti-pencil"></i></span>'); } ?>
