<?php
 function video_link_shortcode($attr, $content=null) : string { return '
    ...
    '; } add_shortcode('video-link', 'video_link_shortcode'); function quotation_shortcode($attr, $content=null) : string { return '
        <blockquote>
