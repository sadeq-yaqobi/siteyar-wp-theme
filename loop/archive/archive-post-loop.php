...
//    $the_query = query_posts($args);
    ...
    update_option('_sy_post_num', $the_query->found_posts);
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                <button id="load_more_archive_btn" type="button" class="btn btn-loader" data-page-slug="post"> نمایش مطالب بیشتر<i
